  ...
  return (
    <div className="min-h-screen bg-emerald-50/50 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto mb-6">
        <Link to="/" className="flex items-center gap-2 text-emerald-700 hover:text-emerald-500 font-semibold transition-colors">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-emerald-100">
          ...
          {cart.length === 0 ? (
            <div className="text-center py-16 flex flex-col items-center gap-4">
              ...
              <p className="text-gray-500 text-lg">Your basket feels light! It's currently empty.</p>
              <Link to="/" className="btn bg-emerald-500 hover:bg-emerald-600 text-white border-none px-6 mt-2">
                Browse Store
              </Link>
            </div>
          ) : (
      ...
      >
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-emerald-100 h-fit sticky top-24">
          ...
          <div className="flex justify-between items-center my-6 font-bold text-2xl text-gray-800">
            <span>Total:</span>
            <span className="text-emerald-600">₦{getCartTotal().toLocaleString()}</span>
          </div>
